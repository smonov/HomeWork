...
Местата винаги се пълнят от началото на ред към края. Тоест за всеки ред, винаги се пълни мястото с по-нисък номер на колоната.
Винаги се пълни първо реда, в който имаме най-малко незаети места.
Ако имаме 2 или повече реда с еднакъв брой незаети места, то започваме да пълним реда, който идва първи. Тоест, реда с по-малък номер на своя ред.
Пълним, докато не напълним всичко.
...
Помислете какво се иска от вас.
Вижте какви помощни функции може да използвате.
Не се притеснявайте да мутирате / променяте киното.
Успех